...
{
    /// <inheritdoc />
    public partial class AddAdminIdentityAndTenants : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: true),
                    IsHostAdmin = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Tenants",
                columns: new[] { "Id", "CreatedUtc", "IsEnabled", "Name", "Slug" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Default", "default" });
