...
/// reset). Kept so the Razor call sites read naturally; all RFC822 composition and CRLF sanitization
/// live once in <see cref="SystemEmail"/>.
/// </summary>
internal static class AccountEmail
{
    public static Task EnqueueAsync(
        ...
        => SystemEmail.EnqueueAsync(queue, from, to, subject, textBody, tenantId, ct);
}
